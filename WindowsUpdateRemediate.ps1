<#	
	...
	===========================================================================
	 ...
	 Nombre de archivo: WindowsUpdateRemediate.ps1
	===========================================================================
	.DESCRIPCIÓN
		Scrip to repair Windows Update with diferent options from Intune Remediation.
#>

$CurrentWin10 = "10.0.19045"
$CurrentWin11 = "10.0.26100"

Start-Transcript -Path "C:\CCMScripts\Intune\WupdateRepair\Logs\#Windows Updates - Health Check.log"
...
#Run DISM
Repair-WindowsImage -RestoreHealth -NoRestart -Online -LogPath "C:\CCMScripts\Intune\WupdateRepair\Logs\#DISM.log" -Verbose -ErrorAction SilentlyContinue
